...
import { My_Type_Img_Name, UseContextProps,My_Type_Color_Background } from "../_inc/my_types";
...
import SimpleCrypto from "simple-crypto-js"; //-------------------------------------this provide crypting and decrypting params in URL
 ...
 const ImgContext = createContext<UseContextProps>({ 
  ...
  simpleCrypto: {}, bgColor:"white", setbgColor:() =>{}  });
...
export const ImgProvider =  ({ children }: { children: ReactNode }) => {
  ...
  return (
    <ImgContext.Provider value={{ imgNames, isLoading, seconds, setSeconds, simpleCrypto, bgColor, setbgColor}}>
      {children}
    </ImgContext.Provider>
  );
};
