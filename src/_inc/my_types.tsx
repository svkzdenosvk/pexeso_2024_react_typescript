...
export type MyTimeAndStartProps = _inc_Type & {
  /*-----------------------------type of props of TimeAndStart component */
  isRunning: boolean;
};

export type MyGameDivPicturesProps = _inc_Type & {
  /*----------------------------type of props of GameDivPictures component */
  level: My_Type_Level;
  selectedImgCount: My_Type_ImgCount;
};

export type UseContextProps = {
  /*---------------------------------------------shared props from useContext -> img names from db  */
...
export type Encrypted = {
  /*----------------------------------------------------encrypt-decrypt type of info to initialize the game */
  level: My_Type_Level;
